...
Before uploading any file to the ESP's 32 it is necessary to include some libraaries, most of them can be installed through arduino's IDE library manager, but the temperature library needs to be installed through:
